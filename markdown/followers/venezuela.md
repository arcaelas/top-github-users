...
The `number of followers` of users in Venezuela on `2022/3/1 6:10 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
