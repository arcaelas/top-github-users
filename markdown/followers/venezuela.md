...
The `number of followers` of users in Venezuela on `2022/4/18 6:08 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
