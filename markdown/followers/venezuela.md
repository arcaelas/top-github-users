...
The `number of followers` of users in Venezuela on `2022/1/31 6:25 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
