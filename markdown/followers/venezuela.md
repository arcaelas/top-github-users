...
The `number of followers` of users in Venezuela on `2022/2/7 12:25 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
