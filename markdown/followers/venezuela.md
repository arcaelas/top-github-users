...
The `number of followers` of users in Venezuela on `2022/6/15 12:08 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
