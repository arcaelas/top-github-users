...
The `number of followers` of users in Venezuela on `2022/1/29 6:51 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
