...
The `number of followers` of users in Venezuela on `2022/5/23 6:07 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
