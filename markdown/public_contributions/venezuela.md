...
The `public contributions` by users in Venezuela on `2022/3/8 12:28 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ethcode1">
				<img src="https://avatars.githubusercontent.com/u/70079260?s=72&u=6b2e9c9580f29926866c9d8a64d008c70e62ccd1&v=4" width="24" alt="Avatar of ethcode1"> ethcode1
			</a><br/>
			@Ξthcode
		</td>
		<td>No Company</td>
