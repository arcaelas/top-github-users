...
The `public contributions` by users in Venezuela on `2022/7/9 12:08 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Jessemccallums">
				<img src="https://avatars.githubusercontent.com/u/101757754?s=72&v=4" width="24" alt="Avatar of Jessemccallums"> Jessemccallums
			</a><br/>
			JesseMcCallums
		</td>
		<td>Microverse </td>
