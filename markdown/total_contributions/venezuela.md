...
The `public contributions` and `private contributions` by users in Venezuela on `2022/5/5 12:08 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
