...
The `public contributions` and `private contributions` by users in Venezuela on `2022/4/4 6:08 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
