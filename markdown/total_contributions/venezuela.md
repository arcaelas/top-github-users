...
The `public contributions` and `private contributions` by users in Venezuela on `2022/3/4 12:33 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
