...
The `public contributions` and `private contributions` by users in Venezuela on `2022/3/8 12:28 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
